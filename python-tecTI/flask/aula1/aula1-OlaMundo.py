...
@app.route('/decorador') # Isso é outro decorator, mapeando a função abaixo para a rota '/hello'
def hello():
     return render_template('decorador.html', mensagem='Hello, World!') # Isso é o que será retornado quando a rota '/hello' for acessada
